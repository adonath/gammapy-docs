...
#
# Finally, we show how to build the mask from a `MapDataset`, finding pixels which contain statistically significant signal. To do so, we use the `LiMaMapEstimator`
#
...
estimator = LiMaMapEstimator("0.4 deg")
